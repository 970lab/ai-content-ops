...
Each artifact is a portable, human-readable record. Store it in the team's declared source location and reference it from one registry; do not create a second ledger or database for the same lifecycle.
